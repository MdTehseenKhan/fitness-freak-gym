  ...
  return (
    <>
      <section className="text-gray-600 body-font ">
        <div className="mx-auto container flex md:flex-row flex-col items-center md:items-start overflow-hidden">
          ...
          <div className="md:w-1/2 w-0 md:float-right">
            <img
              src={HeroBannerImage}
              alt="Banner"
              className="object-cover object-center pointer-events-none rounded-[70px]"
            />
          </div>
        </div>
      </section>
